...
def scrape_glints_jobs(task_id: str, update_state_func=None) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        update_task_progress(
            task_id, "SCRAPING_GLINTS_JOB_DETAIL", progress_data, update_state_func
        )
